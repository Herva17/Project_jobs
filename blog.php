...
<body>
  <nav class="navbar navbar-expand-md  fixed-top maine-menu">
    <div class="container">
      <h1 style="color:  rgb(10, 10, 61);">JOBS</h1>
      ...
      <div id="my-nav" class="collapse navbar-collapse">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item"> <a class="nav-link" href="index.php#about" tabindex="-1" aria-disabled="true">Apropos</a></li>
          <li class="nav-item"> <a class="nav-link" href="index.php#activity" tabindex="-1" aria-disabled="true">Activites</a></li>
          <li class="nav-item"> <a class="nav-link" href="index.php#portfolio" tabindex="-1" aria-disabled="true">Portfolio</a></li>
          <li class="nav-item"> <a class="nav-link" href="index.php#testimonial" tabindex="-1" aria-disabled="true">Temoignage</a></li>
          <li class="nav-item"> <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Blog</a></li>
          <li class="nav-item"> <a class="nav-link" href="index.php#contact" tabindex="-1" aria-disabled="true">Contact</a></li>
          <li class="nav-item"> <a class="nav-link"  href="AuthentJOBS.php" tabindex="-1" aria-disabled="true"><img  src="./assets/img/user-regular-24.png" alt=""></a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="container-fluid fh5co-home-banner">
    <div class="card"> <img class="card-img" src="assets/img/Ordi.PNG" alt="">
      <div class="card-img-overlay">
        <div class="center-text">
          <h2 class="card-title">NOUS VOUS TENONS TOUJOURS INFORMÉS</h2>
          <a href="#" class="btn">
    ...
    <div class="blog-content-bckg">
      <div class="blog-content-inner">
        <div class="container-fluid">
          <h2 class="card-title">Nos derniéres nouvelles du blog</h2>
  ...
  <footer class="container-fluid p-0 pr-0">
    ...
    <div class="copy pt-4 pb-4">
      <p><a href="" target="_blank"> &copy; 2024 JOBS</a>  &nbsp;  |  &nbsp; Design by <a href="" target="_blank">@HervaTech</a> &nbsp; | &nbsp;  All rights reserved</p>
    </div>
  </footer>
